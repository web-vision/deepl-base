...
use TYPO3\CMS\Backend\Controller\Page\LocalizationController as Typo3CoreBackendLocalizationController;
...
return [
    ...
    'records_localize' => [
        ...
        'target' => Typo3CoreBackendLocalizationController::class . '::localizeRecords',
    ],
