...
final class LocalizationControllerTest extends FunctionalTestCase
{
    ...
    public static function gatherLocalizationModesReturnsExpectedDefaultModesBasedOnPageSetupDataSets(): \Generator
    {
    ...
    #[DataProvider('gatherLocalizationModesReturnsExpectedDefaultModesBasedOnPageSetupDataSets')]
    #[Test]
    public function gatherLocalizationModesReturnsExpectedDefaultModesBasedOnPageSetup(
        string $fixtureFile,
        ...
        $modes = $reflectionController->getMethod('gatherLocalizationModes')->invoke(
            $controller,
            $localizationService,
            $modes,
            $site,
