...
**Product:** DeepL Base
**Reference:** DoC-deepl_base-1.1.0

## 1. Product identification

- **Product name:** DeepL Base
...
- **Distribution channels:** TYPO3 Extension Repository (TER) — https://extensions.typo3.org/extension/deepl_base; Packagist — https://packagist.org/packages/web-vision/deepl-base
...
DeepL Base, version 1.1.0, as distributed via the TYPO3 Extension
Repository (TER) and Packagist.
...
> https://security.web-vision.de/conformity/web-vision/deepl-base/1.1.0/en/
