...
This product ("web-vision/deepl-base") is developed and maintained by web-vision GmbH.
...
channels of "web-vision/deepl-base":

- TYPO3 Extension Repository (TER) — https://extensions.typo3.org/extension/deepl_base
- Packagist — https://packagist.org/packages/web-vision/deepl-base
