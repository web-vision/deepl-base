...
**Produkt:** DeepL Base
**Referenz:** DoC-deepl_base-2.1.0

## 1. Produktidentifikation

- **Produktname:** DeepL Base
- **Typ:** TYPO3-Extension
- **Extension Key / Package:** deepl_base (web-vision/deepl-base)
...
- **Vertriebskanäle:** TYPO3 Extension Repository (TER) — https://extensions.typo3.org/extension/deepl_base; Packagist — https://packagist.org/packages/web-vision/deepl-base
...
DeepL Base, Version 2.1.0, vertrieben über das TYPO3 Extension
...
> Elementen des Typs DeepL Base der Verordnung (EU) 2024/2847 entspricht.
>
> Der vollständige Text der EU-Konformitätserklärung ist unter der
> folgenden Internetadresse verfügbar:
> https://security.web-vision.de/conformity/web-vision/deepl-base/2.1.0/de/
